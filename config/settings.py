...
REST_FRAMEWORK = {
    'DEFAULT_AUTHENTICATION_CLASSES': (
        'apps.users.authentication.RevocationAwareJWTAuthentication',
    ),
...
VAPI_CALLS_ENABLED = os.getenv('VAPI_CALLS_ENABLED', 'True').strip().lower() in {'1', 'true', 'yes', 'on'}
VAPI_RETRY_DELAY_MINUTES = int(os.getenv('VAPI_RETRY_DELAY_MINUTES', '5'))
TWILIO_ACCOUNT_SID = os.getenv('TWILIO_ACCOUNT_SID', '')
TWILIO_AUTH_TOKEN = os.getenv('TWILIO_AUTH_TOKEN', '')
TWILIO_WHATSAPP_FROM = os.getenv('TWILIO_WHATSAPP_FROM', '')
TWILIO_WHATSAPP_REPLY_WAIT_MINUTES = int(os.getenv('TWILIO_WHATSAPP_REPLY_WAIT_MINUTES', '2'))
NVIDIA_API_KEY = os.getenv('NVIDIA_API_KEY', '')
NVIDIA_MODEL = os.getenv('NVIDIA_MODEL', 'meta/llama-3.1-8b-instruct')
NVIDIA_MAX_OUTPUT_TOKENS = int(os.getenv('NVIDIA_MAX_OUTPUT_TOKENS', '512'))
NVIDIA_BASE_URL = os.getenv('NVIDIA_BASE_URL', 'https://integrate.api.nvidia.com/v1')
NVIDIA_CONNECT_TIMEOUT_SECONDS = float(os.getenv('NVIDIA_CONNECT_TIMEOUT_SECONDS', '8'))
NVIDIA_READ_TIMEOUT_SECONDS = float(os.getenv('NVIDIA_READ_TIMEOUT_SECONDS', '15'))
